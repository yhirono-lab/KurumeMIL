...
if __name__ == "__main__":
    ...
    DArate = 0
    #result_file = argvs[1]
    result_file = f'test_result/test_{mag1}_{mag2}_train-{train_slide}_DArate-{DArate}_ms.csv'
    output_file = f'test_predict/predict_{mag1}_{mag2}_train-{train_slide}_DArate-{DArate}_ms.csv'
